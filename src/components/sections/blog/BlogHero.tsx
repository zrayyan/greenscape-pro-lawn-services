        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-gray-900 mb-6 leading-tight">
              Lawn Care
              <span className="block text-green-600">Knowledge Hub</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Expert tips, seasonal guides, and educational resources to help you
              maintain a beautiful, healthy lawn year-round.
            </p>
          </motion.div>
